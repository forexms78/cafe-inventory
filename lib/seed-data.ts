...
export const SEED_DATA: SeedItem[] = [
  ...
  // 오믈렛 및 마카롱
  { category: '오믈렛 및 마카롱', name: '우유 오믈렛', min_qty: '4box', stock: 0 },
  { category: '오믈렛 및 마카롱', name: '커스터드 오믈렛', min_qty: '4box', stock: 0 },
  { category: '오믈렛 및 마카롱', name: '녹차 오믈렛', min_qty: '4box', stock: 0 },
  { category: '오믈렛 및 마카롱', name: '초코 오믈렛', min_qty: '4box', stock: 0 },
  { category: '오믈렛 및 마카롱', name: '딸기 마카롱', min_qty: '절반', stock: 0 },
  { category: '오믈렛 및 마카롱', name: '초코 마카롱', min_qty: '절반', stock: 0 },
  { category: '오믈렛 및 마카롱', name: '오레오 마카롱', min_qty: '절반', stock: 0 },
  { category: '오믈렛 및 마카롱', name: '황치즈 마카롱', min_qty: '절반', stock: 0 },
  { category: '오믈렛 및 마카롱', name: '요거트 마카롱', min_qty: '절반', stock: 0 },
  { category: '오믈렛 및 마카롱', name: '얼그레이 마카롱', min_qty: '절반', stock: 0 },
  { category: '오믈렛 및 마카롱', name: '말차 마카롱', min_qty: '절반', stock: 0 },
  // 도쿄롤
