...
| 버전 | 날짜 | 내용 |
|------|------|------|
| v2.14 | 2026-08-03 | chore — 에이전트 참고용 문서 7건을 레포 밖(로컬)으로 이관. README 내 끊긴 참조 정리 |
| v2.13 | 2026-07-23 | 버그 수정 — 다크 테마 입력창 포커스 링·보더 불가시 문제(토큰 폴백이 어두운 배경에 묻힘) 핑크 포커스 색으로 보정 |
